...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function clearForm() {
    ...
    document.getElementById('pubTime').value = '';
  ...
  // Edit article (exposed globally for onclick)
  window.editArticle = function(id) {
    ...
    if (imagePreviewContainer) {
      imagePreviewContainer.innerHTML = `<img src="${article.image}" alt="Preview">`;
    }
  ...
  // Delete article (exposed globally for onclick)
